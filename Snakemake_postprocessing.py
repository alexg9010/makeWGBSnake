...
#SAMPLES = ["236L96-RUNID-0163-FLOWCELL-AHFMF5CCXY-LANE-3"]
#SAMPLES = ["GW3LEP-RUNID-0143-FLOWCELL-BHFCTMCCXY-LANE-6"]
#SAMPLES =["WYKWK3-RUNID-0188-FLOWCELL-BHF5H3CCXY-LANE-7"]
##########################  TODO [END]
...
DIR_mapped      = outputdir+'04_mapping_bwameth_nohardtrimming/'     ############'04_mapping/' ##########################################
...
# FINAL_FILES.extend(
#    expand(DIR_methcall+"{sample}/{sample}_methyldacker_CpG.methylKit",sample=SAMPLES)
# )
# FINAL_FILES.extend(
#    expand(DIR_methcall+"{sample}/tabix/{sample}_methyldacker_cpg_filtered.txt.bgz",sample=SAMPLES)
# )


# # Mbias plot
FINAL_FILES.extend(
   expand(DIR_methcall+"{sample}/{sample}_mbias_methyldackel.txt",sample=SAMPLES)
)
