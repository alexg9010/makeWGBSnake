# PiGx BSseq Pipeline.
#
# Copyright © 2018 Alexander Gosdschan <alexander.gosdschan@mdc-berlin.de>, Katarzyna Wreczycka <katarzyna.wreczycka@mdc-berlin.de>
#
...
if("--help" %in% args) {
  cat("
      ...
      --savefolder a folder which will be used to save methylation call files
      --context a character vector consisting following strings: 'CpG','CHG','CHH'
