...
#' will be executed without sampling. 
#' 
my.methSeg2<-function(obj, diagnostic.plot=TRUE, join.neighbours=FALSE,
                     estimate.params.density=1, ...){
  ...
  if(class(obj)=="methylDiffDB" | class(obj)=="methylRawDB") {
    # get chrs
    chrNum=table(Rsamtools::seqnamesTabix(obj))
